...
public class FamilyMemberAdapter extends ArrayAdapter<FamilyMember> {
    ...
    public FamilyMemberAdapter(Activity context, ArrayList<FamilyMember> familyMembers) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        defaultWord.setText(familyMember.getDefaultTranslation());

        TextView miwokWord = listItemView.findViewById(R.id.miwok);
        miwokWord.setText(familyMember.getMiwokTranslation());
